Shader "N3/DetailBlinnPhongSinDisplaced"
{
    Properties
    {
            ...
            Pass
            {
               ...
               // #include "UnityCG.cginc"
                ...
                v2f vert(appdata v)
                {
                    ...
                    up *= _DisplacementIntensity* sin( 2 * UNITY_PI *_Frequency * _Time + _Time);

                    float3 vertex_displaced = v.object_pos + displace_vector + up;
